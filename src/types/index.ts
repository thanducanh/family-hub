...
export interface BankAccount {
  ...
  displayName?: string; last4?: string; openedAt?: string;
}
...
export interface AppData {
  members: Member[]; tasks: Task[]; transactions: Transaction[]; events: EventItem[]; notes: Note[]; expenseGroups: ExpenseGroup[];
}
