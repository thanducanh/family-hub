...
export interface MemberJob { id: string; memberId: string; title: string; company: string; position: string; startDate: string; endDate: string; status: MemberJobStatus; monthlySalary: number; salaryByMonth: Record<string, number>; note: string; createdAt?: string; updatedAt?: string; }
export interface IncomeRecord { id: string; sourceId?: string; memberId: string; memberName?: string; workId?: string; workName?: string; workSource?: string; incomeDate: string; receivedDate: string; year: number; month: number; category: IncomeCategory; name: string; amount: number; status: IncomeStatus; note: string; createdAt?: string; updatedAt?: string; sourceName?: string; sourceType?: IncomeSourceType; generated?: boolean; }
