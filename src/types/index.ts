...
export interface IncomeRecord { id: string; sourceId?: string; memberId: string; memberName?: string; workSource?: string; incomeDate: string; receivedDate: string; year: number; month: number; category: IncomeCategory; name: string; amount: number; status: IncomeStatus; note: string; createdAt?: string; updatedAt?: string; sourceName?: string; sourceType?: IncomeSourceType; generated?: boolean; }
