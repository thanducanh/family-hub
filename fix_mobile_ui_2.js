...
const t_FinanceDashboardAdjForm = `            <form onSubmit={addAdjustment} className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
...
content = content.replace(t_FinanceDashboardAdjForm, r_FinanceDashboardAdjForm);
...
console.log("Patched Mobile UI box (Rest)");
