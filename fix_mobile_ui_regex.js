...
// Let's use a regex to match it more flexibly
const regex = /<div className="mb-3 rounded-\[20px\] border border-\[#E8DCD5\] bg-\[var\(--mobile-card\)\] p-4 text-\[#171018\] shadow-\[0_6px_18px_rgba\(128,0,32,0\.07\)\]">[\s\S]*?Tiền đang có hiện tại.*?<\/p>/m;
...
if (regex.test(content)) {
  ...
  console.log("Replaced UI via regex");
} else {
