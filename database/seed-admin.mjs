...
try {
  const result = await pool.query(
    `INSERT INTO users (username, display_name, password_hash, password_plain, role, active, must_change_password, is_system)
     VALUES ('admin', 'Quản trị hệ thống', $1, 'admin123', 'full_access', TRUE, TRUE, TRUE)
